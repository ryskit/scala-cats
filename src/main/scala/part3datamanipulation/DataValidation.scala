...
//  val tryToValidated: Validated[List[String], Int] =
//    Validated.fromTry(Try("something".toInt))
  ...
  object FormValidation {
    ...
    def getValue(form: Map[String, String],
                 fieldName: String): FormValidation[String] =
    ...
    def passwordCheck(password: String): FormValidation[String] =
      Validated.cond(
        password.length >= 10,
        password,
        List("Password must be at least longer than 10 characters long.")
      )
